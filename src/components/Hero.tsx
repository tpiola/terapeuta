        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative">
              <div className="absolute -inset-4 rounded-3xl bg-gradient-to-br from-brand-sage/20 via-brand-lavender/15 to-brand-gold/10 blur-2xl" />
              <img
                src="/images/elis-hero.jpg"
                alt="Elis Regina Borges — Terapeuta Integrativa"
                className="relative w-full max-w-[420px] h-auto rounded-2xl shadow-2xl object-cover aspect-[3/4]"
                loading="eager"
              />
            </div>
          </motion.div>
